                                ...
                                <ul class="list-unstyled components">                                  
                                    ...
                                    <?php $i = 0;foreach($_SESSION['modulos'] as $padre){?>
                                        <?php if(count($padre->modulos_hijos)>0):?>
                                            <li class="dropdown">
                                                <a href="#homeSubmenu_<?= $i?>" class="dropdown-toggle" data-toggle="collapse" aria-expanded="false"><div class="img"><img src="<?= base_url();?>images/menus/<?= $padre->mod_imagen?>" height="41" width="41" style="margin:5px 25px;"/></div><?= $padre->mod_descripcion?></a>
