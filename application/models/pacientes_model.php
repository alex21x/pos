...
class Pacientes_model extends CI_Model
{
	...
	public function guardarPaciente_v(){
       ...
       copy($_FILES['foto']['tmp_name'], $destino);
		...
		if($_POST['id']  == '' ){
			...
			if($_FILES['foto']['name'] != '')
				$dataUpdate = array_merge($dataUpdate,array('foto' => $_FILES['foto']['name']));
	...
	foreach ($rsPacientes as $paciente) {		
		...
		$paciente->boton_pdf = '<a href="'.base_url().'index.php/pacientes/descargarPdf/'.$paciente->id.'" target="_seld" ><img src="'.base_url().'/images/pdf.png" data-id="'.$paciente->id.'" class="descargar-pdf"></a>';
	}
