...
class Historias_model extends CI_Model
{
	...
	public function getMainList(){
		...
		$select = $this->db->select('his.his_id his_id, his.his_correlativo correlativo, DATE_FORMAT(his.his_fecha, "%d-%m-%y") his_fecha,DATE_FORMAT(his.his_fecha_cita, "%d-%m-%y %h:%i") his_fecha_cita,DATE_FORMAT(his.his_proxima_cita, "%d-%m-%y %h:%i") his_proxima_cita,pac.razon_social pac_razon_social,pac.telefono pac_telefono,prof.prof_nombre prof_nombre,esp.esp_descripcion,CONCAT(emp.nombre," ",emp.apellido_paterno) empleado,hie.hie_id,hie.hie_descripcion estado,CONCAT(hec.hec_descripcion," / ",his.his_documento_venta) estadoComprobante',FALSE)
		 					->from('historias his')
		 					->join('pacientes pac','pac.id = his.his_paciente_id')
	      ...
	      foreach ($rsHistorias as $historia) {
              ...
              $historia->btn_popup = '<a class="btn_popup" data-id = "'.$historia->his_id.'" data-toggle="modal" data-target="#myModal" ><span class="glyphicon glyphicon-file"></a>';              
    ...
    public function exportarReporteHistoria(){
		...
		$rsHistorias = $this->db->select('his.his_id his_id, DATE_FORMAT(his.his_fecha, "%d-%m-%y") his_fecha,DATE_FORMAT(his.his_fecha_cita, "%d-%m-%y %h:%i") his_fecha_cita,DATE_FORMAT(his.his_proxima_cita, "%d-%m-%y %h:%i") his_proxima_cita,pac.razon_social pac_razon_social,pac.telefono pac_telefono,prof.prof_nombre prof_nombre,esp.esp_descripcion,CONCAT(emp.nombre," ",emp.apellido_paterno) empleado,hie.hie_id,hie.hie_descripcion estado,CONCAT(hec.hec_descripcion," / ",his.his_documento_venta) estadoComprobante, his.his_motivo motivo, his.his_ini_peso peso_ini, his.his_fin_peso peso_fin, his.his_ini_talla talla, his.his_ini_temperatura temperatura ,his.his_codigo_cie codigo_cie, his.his_enfermedad_actual enfermedad_actual,his.his_diagnostico diagnostico, his.his_recomendacion recomendacion, his.his_tratamiento tratamiento',FALSE)
		 					->from('historias his')
		 					->join('pacientes pac','pac.id = his.his_paciente_id')
		 					->join('profesionales prof','prof.prof_id =  his.his_profesional_id')
		 					->join('especialidades esp','esp.esp_id = prof.prof_especialidad_id')
