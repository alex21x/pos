    ...
    public function buscador_itemC() {
     ...
     public function guardar_comprobante() {
        ...
        if($_POST['notap_id'] != ''){
            ...
            $this->db->where('notap_id',$_POST['notap_id']);
        ...
        $descripcion = $_POST['descripcion'];
        $serie_detalle = $_POST['serie_detalle'];
        $medida        = $_POST['medida'];
        $cantidad      = $_POST['cantidad'];
        ...
        foreach ($idproduc as $item) {
            ...
            $dataDetalleInsert["serie_detalle"] = $serie_detalle[$i];
            ...
            if($result->prod_tipo == 1){                                
                    if($_POST['tipo_documento'] != 7 and $_POST['tipo_documento'] != 9){                         
                         ...
                         $this->productos_model->salidaStock($idproduc[$i] ,$cantidad[$i], $concepto, $comprobante_id, $serie, $numero, $result->prod_almacen_id, 2);
                         ...
                         $this->productos_model->ingresarStock($idproduc[$i] ,$cantidad[$i], $concepto, $comprobante_id, $serie, $numero, $result->prod_almacen_id, 2);                         
                    }                                        
            }
            $i++;
        }
...
//            '',
    ...
    public function exportarExcel()
    {
        ...
        $resultComprobantes = $this->db->from("comprobantes com")
                                       ->join("monedas mon","mon.id = com.moneda_id")
                                       ->get()
                                       ->result();
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('M1', "MONEDA");
        $objPHPExcel->getActiveSheet()->setCellValue('N1', "ESTADO SUNAT");
        $objPHPExcel->getActiveSheet()->setCellValue('O1', "METODO DE PAGO");
        $objPHPExcel->getActiveSheet()->setCellValue('P1', "USUARIO");
        $objPHPExcel->getActiveSheet()->setCellValue('Q1', "UTILIDAD");
        $objPHPExcel->getActiveSheet()->setCellValue('R1', "TRANSPORTISTA");
        $objPHPExcel->getActiveSheet()->setCellValue('S1', "PLACA");
        $objPHPExcel->getActiveSheet()->setCellValue('T1', "ORDEN DE COMPRA");
        $objPHPExcel->getActiveSheet()->setCellValue('U1', "ALMACEN");
        $objPHPExcel->getActiveSheet()->setCellValue('V1', "OBSERVACION");
        ...
        foreach($resultComprobantes as $index => $item)
        {
            ...
            $objPHPExcel->getActiveSheet()
                        ...
                        ->setCellValue('M' . ($i), $item->moneda)
                        ->setCellValue('N' . ($i), $estado)
                        ->setCellValue('O' . ($i), $rsPago)
                        ->setCellValue('P' . ($i), $rsEmpleado->nombre.' '.$rsEmpleado->apellido_paterno)
                        ->setCellValue('Q' . ($i), $rsUtilidad->totalVenta - $rsUtilidad->totalCosto)
                        ->setCellValue('R' . ($i), $rsTransportista->transp_nombre)
                        ->setCellValue('S' . ($i), $rsCliente->placa)
                        ->setCellValue('T' . ($i), $item->orden_compra)
                        ->setCellValue('U' . ($i), $this->session->userdata('almacen_nom'))
                        ->setCellValue('V' . ($i), $item->notas);
            
            if($item->moneda_id == 1){//SOLES
                    $suma_totalSoles = ($item->tipo_documento_id == 7 or $item->tipo_documento_id == 9) ? $suma_totalSoles - $item->total_a_pagar : $suma_totalSoles + $item->total_a_pagar;                
            } else if($item->moneda_id == 2){//DOLARES
                    $suma_totalDolares = ($item->tipo_documento_id == 7 or $item->tipo_documento_id == 9) ? $suma_totalDolares - $item->total_a_pagar : $suma_totalDolares + $item->total_a_pagar;
            }            
            
            $i++;
        }
        $objPHPExcel->getActiveSheet()->getStyle('K' . ($i + 1 ))->getFont()->setBold(true);
        $objPHPExcel->getActiveSheet()->setCellValue('K' . ($i + 1 ), 'TOTAL SOLES');
        $objPHPExcel->getActiveSheet()->setCellValue('L' . ($i + 1 ), $suma_totalSoles);


        $objPHPExcel->getActiveSheet()->getStyle('K' . ($i + 2 ))->getFont()->setBold(true);
        $objPHPExcel->getActiveSheet()->setCellValue('K' . ($i + 2 ), 'TOTAL DOLARES');
        $objPHPExcel->getActiveSheet()->setCellValue('L' . ($i + 2 ), $suma_totalDolares);
    ...
    public function exportarExcel_rd()
    {
        ...
        foreach($resultComprobantes as $index => $item)
        {
            ...
            $objPHPExcel->getActiveSheet()                        
              ...
              if($item->moneda_id == 1){//SOLES
                    $suma_totalSoles = ($item->tipo_documento_id == 7 or $item->tipo_documento_id == 9) ? $suma_totalSoles - $item->total : $suma_totalSoles + $item->total;                
            } else if($item->moneda_id == 2){//DOLARES
                    $suma_totalDolares = ($item->tipo_documento_id == 7 or $item->tipo_documento_id == 9) ? $suma_totalDolares - $item->total : $suma_totalDolares + $item->total;
            }            
         ...
         $objPHPExcel->getActiveSheet()->setCellValue('L' . ($i + 2 ), 'MONTO DOLARES');
    ...
    public function init_dashboard(){
        ...
        $response['a'] = $com1->total_a_pagar+$com3->notap_total-$com2->total_a_pagar;
        ...
        $this->db->where('notap_estado',1); 
        $com3 = $this->db->get('nota_pedido')->row(); 
        $response['b'] = $com1->total_a_pagar+$com3->notap_total-$com2->total_a_pagar;
        ...
        $response['c'] = $com1->total_a_pagar-$com2->total_a_pagar;
    ...
    {        
        ...
        ////DATOS ITEMS 
            ...
            foreach($items as $i){
                ...
                $datos_item['descripcion'] = $i->descripcion.' '.$i->serie_detalle;
    ...
    public function devolverStock($comprobante_id){//DEVOLVER STOCK //08-04-2021
            //DEVOLVER STOCK 03-11-2020        
            $rsProductos = $this->db->from('items ite')
                                   ->join('comprobantes com','com.id = ite.comprobante_id')
                                   ->join("productos pro","pro.prod_id = ite.producto_id")
                                   ->where('ite.comprobante_id',$comprobante_id)
                                   ->get()
                                   ->result();

            foreach ($rsProductos as $rsProducto) {
                $this->productos_model->ingresarStock($rsProducto->producto_id ,$rsProducto->cantidad, $concepto = 'RESTAURAR STOCK',$comprobante,$rsProducto->serie,$rsProducto->numero,$rsProducto->prod_almacen_id);
            }            
    }
    ...
    function updateEstadoANULACION(){
        ...
        if($numero != 'none'){
            if($estado == 5){//ESTADO ANULADO
                $this->devolverStock($comprobante);//DEVUELVE STOCK
                $fecha = date('Y-m-d');
                $dataAnular = array(
                                'fecha' => $fecha,
                                'numero' => $numero,
        ...
        if($numero != 'none'){
            if($estado == 5){//ESTADO ANULADO
                ...
                foreach($datos as $value){
                    $this->devolverStock($value->comprobante_id);//DEVUELVE STOCK                    
  ...
  public function buscar_documento_s(){
    ...
    switch ($_POST['tipo_documento_id']) {
        case ST_NOTA_PEDIDO:
            ...
            $documento->url2 = '<a href="'.base_url().'index.php/notas/comprobanteNotaVenta/'.$documento->documento_id.'/1" target="_seld"><span class="glyphicon glyphicon-export"></span></a>';
        ...
        case ST_PROFORMA:
            ...
            $documento->url2 = '<a href="'.base_url().'index.php/proformas/comprobanteNotaVenta/'.$documento->documento_id.'/1" target="_seld"><span class="glyphicon glyphicon-export"></span></a>';
        ...
        case ST_COMPROBANTE:
            ...
            $documento->url2 = '<a href="'.base_url().'index.php/comprobantes/comprobanteNotaVenta/'.$documento->documento_id.'/1" target="_seld"><span class="glyphicon glyphicon-export"></span></a>';
    ...
    $tabla = '<table class="table table-hover">        
                ...
                <td class="text-center">TRIBUTARIO</td>
                <td class="text-center">NOTA DE VENTA</td>
                </tr>';
    ...
    $tabla .=  '<tr>
                ...
                <td class="text-center">'.$documento->a4.'</td>
                <td class="text-center">'.$documento->url.'</td>
                <td class="text-center">'.$documento->url2.'</td>
                </tr>
                </table>';
    ...
    $cabecera['cliente_domicilio'] = $rsComprobante->direccion_cliente;
    ...
    foreach ($rsComprobante->detalles as $value) {
            ...
            $item['serie_detalle'] = $value->serie_detalle;
            $item['producto_id'] = $value->producto_id;
            $item['unidad_id']   = $value->unidad_id;
            $item['cantidad']    = $value->cantidad;
            $item['tipo_igv_id'] =  $value->tipo_igv_id;
            $item['importe'] = $value->importe;
            $item['importeCosto'] = $value->importeCosto;
            $item['total'] = $value->total;
            $item['totalCosto'] = $value->totalCosto;
            $item['totalVenta'] = $value->totalVenta;
            $items[] = $item;
    }
    ...
    {        
        ...
        $datos['tipo_de_cambio'] = $comprobante->tipo_de_cambio;
     ...
     public function getDatosAnulacion_PSE()
    {
        ...
        if($comprobante->codigo == '03'){
          $this->devolverStock($id);//DEVOLVER STOCK PSE
          $this->resumenes_model->guardarResumen($id,3);
          $datos['go'] = 1;
          echo json_encode($datos);
          exit();
    ...
    public function getDatosAnulacion_PSEPASSWORD()
    {
        $opc = $this->input->get('opc');  
        $id = $this->input->get('comprobante_id');
        $password = $this->input->get('password');
