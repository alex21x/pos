...
class Guias extends CI_Controller
{
    ...
    public function getDatosXML(){    
        ...
        $guia = $this->db->select('gui.*,tpc.codigo transporte_codigo,tcc.codigo conductor_codigo,gmt.codigo motivo_codigo,gmt.descripcion motivo_descripcion,gmd.codigo modalidad_codigo')
                         ->from('guias gui')
