...
class Download extends CI_Controller {
    ...
    public function downloadPdf_pf($proforma_id){
        $proforma = $this->proformas_model->select($proforma_id);     
        $this->create_pdf_pf($proforma_id);
    }
    ...
    public function downloadPdfTicket_pf($proforma_id){
        $proforma = $this->proformas_model->select($proforma_id);
        $this->pdfTicket_pf($proforma_id);
    }
    ...
    public function create_pdf_pf($idProforma){
       ...
       require_once (APPPATH .'libraries/Numletras.php');
        ...
        $this->pdf->stream("N.Proforma.NP-$idProforma.pdf",
            array("Attachment"=>0)
        );        
    }
    ...
    public function pdfTicket_pf($idProforma){
