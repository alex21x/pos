<div class="modal-dialog" role="document">
	<div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Subir CIE</h4>
      </div>
...
<script>
 	$(document).ready(function(){
      $('#msj-error').hide();
	    $("#files").kendoUpload({
	        async: {
	            saveUrl: "<?php echo base_url()?>index.php/cie/guardarsubidacie",
	            autoUpload: true,
	        },
          multiple:false,
          validation: {
          ...
          progress:function(){
	        ...
	        success:function(){
	           dataSource.read();
             toast("success", 1500, "CIE subidos con exito!");
	        },
	        error:function(e){
            toast("error", 1500, "No se pudo subir CIE");
            $('#msj-error').show();
