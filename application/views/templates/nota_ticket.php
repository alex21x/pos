 ...
 ?>
        ...
        <span id="height-container">
            ...
            <p class="datos_cliente"> CLIENTE<br>
                ...
                DIRECCION:<?php echo "  ". $nota->notap_cliente_direccion;?><br>
                ----------------------------------------------------------------------<br>                
            </p>            
            <table width="100%">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tabla_cabecera"><?php echo $item->notapd_descripcion.' '.$item->notapd_serie_detalle?></td>
                        <td class="tabla_datos_cantidad"><?php echo $nota->simbolo.$item->notapd_precio_unitario?></td>
                        <td class="tabla_datos_cantidad"><?php echo $nota->simbolo.$total?></td>
                    </tr>
                    <?php                     
                    }
                    ?>
