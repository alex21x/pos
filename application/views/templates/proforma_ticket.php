 ...
 ?>
        ...
        <span id="height-container">
            <p align="center" class ="datos_titulo1">
                ...
                -------------------------------------------------------<br><br>
                Cliente: <?php echo $cliente->razon_social?> <?php echo $comprobante->nombres?></br><?php if($nota->tipo_cliente_id==1):?>D.N.I: <?php else:?> R.U.C <?php endif?><?php echo "  ". $cliente->ruc?><br>
                DIRECCION:<?php echo "  ". $proforma->prof_direccion?><br>
                <?php if($cliente->placa != '') {?> Placa: <?php echo $cliente->placa?></td><?php } ?><br>
                -------------------------------------------------------<br>                
            </p>            
            <table width="100%">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tabla_cabecera"><?php echo $item->profd_descripcion.' '.$item->profd_serie_detalle?></td>
