 ...
 ?>
        ...
        <span id="height-container">
            <p class ="datos_titulo1 cabecera">
                ...
                DIRECCION:<?php echo "  ". $comprobante->direccion_cliente?><br>
                ----------------------------------------------------------------------<br>                
                </p>                
            </p>            
            <table width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="8" align="center" class="tabla_cabecera">P/U</th>
                        <th width="8" align="center" class="tabla_cabecera">TOTAL</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tabla_cabecera" width="8"><?php echo $item->descripcion.' '.$item->serie_detalle?></td>
                        <td class="tabla_datos_cantidad"><?php echo $comprobante->simbolo.$item->importe?></td>
                        <td class="tabla_datos_cantidad"><?php echo $comprobante->simbolo.$total?></td>
                    </tr>
                    <?php                     
                    }
                    ?>
