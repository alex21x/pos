...
<?php 
 ...
 ?>    
	...
	<?PHP $i= 0; foreach($historias as $historia){?>
    <div class="datosPaciente">        
 		<table class="datos_titulo">
            ...
            <table class="datos_cliente">
                ...
                <tr>
                    <td>FINAL</td>
                    <td><b>PESO:</b> <?php echo "  ". $historia->his_fin_peso?></td>                    
                    <td><b>TALLA:</b> <?php echo "  ".$historia->his_fin_talla?></td>
                    <td><b>TEMP:</b> <?php echo "  ". $historia->his_fin_temperatura;?></td>
                    <td><b>PRESION:</b> <?PHP echo " ".$historia->his_fin_presion_arterial;?></td>
                    <td><b>OTROS:</b> <?PHP echo " ".$historia->his_fin_otros;?></td>
                </tr>                      
            </table><br>
            ...
            <table class="datos_imagen">                                        
                ...
                <?PHP foreach($historia->imagenes as $val){?>
                <tr>
                    <td>                        
                        <div id="images_gallery">
                          <img class="imagenHistoria" src="<?php echo 'images/historias/'.$val->hii_foto;?>">
                        </div>
                    </td>
                </tr>                  
                <?PHP }?>
