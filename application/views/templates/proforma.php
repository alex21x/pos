        ...
        <td>
            ...
            <div class="tabla_borde" >                
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        <td>
                        <?php if($cliente->placa != '') {?><strong>Placa: </strong> <?php echo $cliente->placa?></td><?php } ?>
                    </tr>
                    ...
                    <tbody>
                        ...
                        <tr class="border_top">
                            ...
                            <td align="center" width="250px">
                                <span><?php echo $item->profd_descripcion.' '.$item->profd_serie_detalle?></span><br>
                            </td>
                            <td align="center">
                                <?php echo $proforma->alm_nombre?>
                            </td>
                            <td align="center">
