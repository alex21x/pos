...
<head>
    ...
    body{<?= $anulado?>;background-repeat:no-repeat;background-position:center center;text-align:center;margin:0;font-family: Verdana, monospace}  
    ...
    <tbody><tr>
        <td>
            ...
            <div class="tabla_borde" >
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                        <?php if($nota->placa != '') {?><strong>Placa: </strong> <?php echo $nota->placa?></td><?php } ?>
                    </tr>                    
                    </tbody></table>
            </div><br>
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tbody>
                        <tr>
                            ...
                            <td align="center" class="bold">Almacen</td>
                        ...
                        <tr class="border_top">
                            ...
                            <td align="center" width="300px">
                                <span><?php echo $item->notapd_descripcion.' '.$item->notapd_serie_detalle?></span><br>
                            </td>
                            <td align="center" width="20px">
                                 <?php echo $item->alm_nombre?>
                            </td>
                            <td align="left">
                            	<?php echo $nota->simbolo?> <?php echo $item->notapd_precio_unitario?>
                            </td>
                           <!-- <td align="center">
                            	<?php echo $comprobante->simbolo?> <?php echo $item->notapd_descuento?>
                            </td>   -->                         
                            <td align="center">
                            	<?php echo $nota->simbolo?> <?php echo $item->notapd_total?>
                            </td>
                            <td>
                                
                            </td>
                        </tr>
                         <?PHP if($nota->notap_mostrar_imagen == 1 && $item->prod_imagen != ''){?>                            
                            <tr>
                                <td align="center"><STRONG>DESCRIPCION:</STRONG><?php echo $item->prod_observaciones ?><br><br><br>
                                                   <strong>GARANTIA:</strong><br><?php echo $item->prod_garantia ?>            
                                </td>
                             
                                <td align="center" colspan="6"><img class="prod_imagen" src="<?= 'images/productos/'.$item->prod_imagen;?>" width="150" height="150"></td>
                            </tr>
                        <?PHP }?> 
                   		<?php endforeach?>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <td width="50%" valign="top">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-valores-totales">
                            ...
                            <tr>
                                ...
                                <td width="120" align="right"><span><?php echo $nota->simbolo?> <?php echo $nota->notap_total?></span></td>
                            </tr>
                            </tbody>
                        </table>
                    </td>
                ...
                <tr>
                    <td>
                        <span style="font-family:Tahoma, Geneva, sans-serif; font-size:12px" text-align="center"><strong>SON: <?php echo $nota->total_letras?></strong></span>
                                    <br>                                    
                    </td>
                  ...
                  <tr>
                    <td></td>
                      <td style="text-align: left;"  class="valores_totales"> 
                                <strong><?php echo $empresa->empresa?></strong><br>
