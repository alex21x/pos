       	...
       	<input type="hidden" id="id" name="id" value="<?php echo $paciente->id;?>">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" name="estado_civil" id="estado_civil" value="<?PHP echo $paciente->estado_civil;?>">
                        </div>
                    </div>    
                    <div class="form-group">
                        <label for="estado_civil" class="col-sm-5 control-label">Correo </label>
                        <div class="col-xs-7">
                            <input type="email" class="form-control" name="correo" id="correo" value="<?PHP echo $paciente->correo;?>">
                        </div>
                    </div>               
                    <div class="form-group">
      ...
      $("#btn_guardar_paciente").on('click',function(){        
        ...
        e.preventDefault();
          ...
          processData:false,  			
              ...
              if(response.tipo == '2')
              {                
                toast('error', 1500, 'Paciente ya registrado');
              }
  					}
