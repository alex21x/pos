  ...
  <form id="formReporte">
    <div class="row">
        ...
        <div class="col-md-2"  style="padding:10px;">
          ...
          <button class="btn btn-success btn-sm colbg" type="button" id="exportar_repo">Eportar excel</button>
        </div>          
    </div></form>
    <br>
...
<script type="text/javascript">
            ...
            $.getJSON("<?php echo base_url()?>index.php/productos/kardex_fisico_producto",{producto_id,almacen,fechai,fechaf})
             .done(function(json){
                  ...
                  var table = '';
                      ...
                      table+= '<td style="background:#BFC9CA;">USUARIO</td>';
                  ...
                  $.each(json,function(index,value){
                      ...
                      table+= '<td style="font-weight:normal;">'+ value.nombre +' '+value.apellido_paterno+' '+value.apellido_materno+'</td>';
    ...
    $('#exportar_repo').click(function(){
        ...
        almacenText = ($("#almacen option:selected").val() != '') ? $("#almacen option:selected").text() : '';
        productoText = ($("#producto").val() != '') ? $("#producto").text() : '';
        //var url ='<?PHP //echo base_url() ?>index.php/productos/exportarKardex?'+datos+'&vendedorText='+vendedorText;
        var url ='<?PHP echo base_url() ?>index.php/productos/exportarKardex?'+datos+'&almacenText='+almacenText+'&productoText='+productoText;
