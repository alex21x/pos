        ...
        <td>
                    ...
                    <td width="44%"  valign="bottom" style="padding-left:0;">
                        <div  style="border:2px solid #aaa;border-radius:10px;height: 160px">
                            <table width="100%" border="0"  cellpadding="14" cellspacing="0">
                                ...
                                <tr>
                                    <td align="center">
                                      <?php if($rsReporteLote->tipo_documento_id == 9 or $rsReporteLote->tipo_documento_id == 7){?>
                                           <span style="font-family:Tahoma, Geneva, sans-serif; font-size:20px" text-align="center">NOTA DE CREDITO</span><br>
                                           <span style="font-family:Tahoma, Geneva, sans-serif; font-size:20px" text-align="center">E L E C T R Ó N I C A</span>
                                      <?php }else if($rsReporteLote->tipo_documento_id==10 or $rsReporteLote->tipo_documento_id==8){ ?>  
                                             <span style="font-family:Tahoma, Geneva, sans-serif; font-size:20px" text-align="center">NOTA DE DEBITO</span><br>
                                             <span style="font-family:Tahoma, Geneva, sans-serif; font-size:20px" text-align="center">E L E C T R Ó N I C A</span>
                                      <?php }else{ ?>  
                                         <span style="font-family:Tahoma, Geneva, sans-serif; font-size:20px" text-align="center"><?php echo strtoupper($rsReporteLote->tipo_documento) ?></span><br><br><br><br><br>
                                         <span style="font-family:Tahoma, Geneva, sans-serif; font-size:20px" text-align="center">E L E C T R Ó N I C A</span>
                                      <?php } ?>  
                                        <br><br><br><br><br><br>                                        
                                    </td>
                                ...
                                <tr>
                                    <td align="center">
                                         <span style="font-family:Tahoma, Geneva, sans-serif; font-size:20px" text-align="center">No.: <?php echo $rsReporteLote->nserie?>-    <?php echo str_pad($rsReporteLote->nDocumento, 8, "0", STR_PAD_LEFT)?></span>
                                    </td>
                                </tr>                                
                               </table>
                        </div>
            ...
            <div class="tabla_borde" >                
                <table width="100%" border="0" cellpadding="6" cellspacing="0" style="padding-top: 5px">
                    <tbody>
                    <tr>
                        <td width="60%" align="left" colspan="2"><strong>Razón Social:</strong>  <?php echo $rsReporteLote->razon_social_cliente?></td>
                        <td width="40%" align="left"><strong><?php if($comprobante->tipo_cliente_id==1):?>D.N.I<?php else:?>R.U.C<?php endif?></strong>  <?php echo $rsReporteLote->cliente_ruc?> </td>
                    </tr>
                    <tr>
                        <td width="40%" align="left" colspan="3"><strong>Dirección: </strong>  <?php echo $rsReporteLote->cliente_domicilio?></td>
                    </tr>
                    <tr>
                        <td width="60%" align="left">
                            <strong>Fecha Emisión: </strong><?php echo $rsReporteLote->fecha_de_emision?>                                                        
                        </td>
                        <td width="60%" align="left">
                            <strong>Fecha Vencimiento: </strong><?php echo $rsReporteLote->fecha_de_vencimiento?>           
                        </td>                        
                        <td>
                    ...
                    <tr>
                        <td width="60%" align="left"><strong>Tipo Moneda: </strong> <?php echo strtoupper($rsReporteLote->moneda)?></td>
                        <td width="60%" align="left"><strong>Transportista: </strong> <?php echo strtoupper($rsReporteLote->transp_nombre)?></td> 
                                ...
                                <td width="50%" style="text-align: right;">    
                                   <table border="0" width="100%">
                                    ...
                                    <table width="100%" border="0" class="pie_de_pagina">
                                        <tbody>
                                     <?php if($rsReporteLote->tipo_documento_id != 0){?>      
                                        <?php if($rsReporteLote->total_anticipos > 0):?>
                                        <tr>
                                            <td><strong>Total Anticipo:</strong></td>
                                            <td><span><?php echo $comprobante->simbolo?> <?php echo $rsReporteLote->total_anticipos?></span></td>
                                        </tr>
                                        <?php endif?>
                                        <?php if($rsReporteLote->descuento_global > 0):?>
                                        <tr >
                                            <td><strong>Descuento Global:</strong></td>
                                            <td><span><?php echo $rsReporteLote->simbolo?> <?php echo $rsReporteLote->descuento_global?></span></td>
                                        </tr>
                                        <?php endif?>                                                       
                                        <tr >
                                            <td><strong>Op. Gravadas:</strong></td>
                                            <td><span><?php echo $rsReporteLote->simbolo?> <?php echo $rsReporteLote->total_gravada?></span></td>
                                        </tr>                            
                                        <tr >
                                            <td><strong>Op. Inafectas:</strong></td>
                                            <td ><span><?php echo $rsReporteLote->simbolo?> <?php echo $rsReporteLote->total_inafecta?></span></td>
                                        </tr>
                                        <tr >
                                            <td><strong>Op. Exoneradas:</strong></td>
                                            <td ><span><?php echo $rsReporteLote->simbolo?> <?php echo $rsReporteLote->total_exonerada?></span></td>
                                        </tr>                            
                                        <?php if($rsReporteLote->total_igv > 0):?>
                                        <tr >
                                            <td><strong>IGV:</strong></td>
                                            <td ><span><?php echo $rsReporteLote->simbolo?> <?php echo $rsReporteLote->total_igv?></span></td>
                                        </tr>
                                        <?php endif?>
                                        <?php if($rsReporteLote->total_icbper > 0):?>
                                        <tr>
                                            <td><strong>ICBPER:</strong></td>
                                            <td><span><?php echo $rsReporteLote->simbolo?> <?php echo $rsReporteLote->total_icbper?></span></td>
                                        </tr>
                                        <?php endif?>                            
                                        <?php if($rsReporteLote->total_otros_cargos > 0):?>
                                        <tr>
                                            <td><strong>Otros Cargos:</strong></td>
                                            <td><span><?php echo $rsReporteLote->simbolo?> <?php echo $rsReporteLote->total_otros_cargos?></span></td>
                                        </tr>
                                        <?php endif?>
                                    <?php } ?>
                                        <tr class="border_bottom monto_a_pagar">
                                            <td><strong>Total a Pagar:</strong></td>
                                            <td><span><?php echo $rsReporteLote->simbolo?> <?php echo $rsReporteLote->total_a_pagar?></span></td>
                                        </tr>   
