...
<script>
	...
	$("#gridHistoria").kendoGrid({
		...
		sortable: true,
		pageable: true,
		columns: [  {hidden:'id',title:'N°',width:'80px',template:"#= id #"},
				    {field:'correlativo',title:'N°',width:'80px'},
                    ...
                    //boton pdf
                    {field:'btn_popup', title:'&nbsp;',width:'40px',template:"#= btn_popup #"},
    ...
    //MODAL ENVIO DE HISTORIAS BTN_POPUP
