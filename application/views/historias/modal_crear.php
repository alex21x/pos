 ...
 $("#fecha_nacimiento").datepicker({
       ...
       <form id="formHistoria">
            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">         
                ...
                <div class="form-group">                         
                  ...
                  <div class="col-xs-2 col-md-4 col-lg-2">
                      <label>Talla
                        <input type="text" class="form-control" name="talla_fin" name="talla_fin" value="<?= $historia->his_fin_talla?>">
                      </label>
                  </div>
                  <div class="col-xs-2 col-md-4 col-lg-2">
                      <label>Temperat.
        ...
        <div class="row">
          <div class="col-xs-12 col-md-12 col-lg-12">                 
            ...
            <button type="button" class="btn btn-warning btn-sm imprimirReceta" onclick="javascript:imprimirReceta();">Imprimir Solicitud</button>
          </div>
        </div>
          </div>
        </div> 
  ...
  <script>
    ...
    $('.imprimirReceta').click(function() {
      ...
      var formHistoria =  $("#formHistoria").serialize();
      
        var _val = $(this).attr("idval");
             javascript:window.open('<?PHP echo base_url() ?>index.php/historias/imprimirReceta?'+formHistoria+'','','width=750,height=600,scrollbars=yes,resizable=yes');                    
    });


    function imprimirReceta1(){
    ...
    //AUTOCOMPLETE PRODUCTO - ALEXANDER FERNANDEZ DE LA CRUZ
      ...
      $("#btn_guardar_historia").click(function(){
          ...
          processData:false,
              ...
              $("#myModal").modal('hide');
              $("#historia_id").val(response.his_id);
                setTimeout(function() { 
                      $('#btnHistoria').trigger('click');dataSource.read();
                }, 2000);                
  					}
  				}
  			});  					
