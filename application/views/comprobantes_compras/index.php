    ...
    $(document).ready(function () {
        ...
        $(document).on('ready',function() {
            $("#cliente").autocomplete( {
                source: '<?PHP echo base_url(); ?>index.php/comprobantes_compras/buscador_cliente',
                minLength: 2,
            ...
            $('#exportarExcel').click(function(){
                ...
                var url = '<?PHP echo base_url() ?>index.php/comprobantes_compras/exportarExcel/' + cliente_id + '/' +  fecha_de_emision_inicio + '/' + fecha_de_emision_final + '/' + serie + '/' + numero + '/' + empresa_id + '/'+ numero_pedido+ '/' + orden_compra + '/' + numero_guia;
            ...
            $('#exportarExcel_rd').click(function(){
                ...
                var url = '<?PHP echo base_url() ?>index.php/comprobantes_compras/exportarExcel_rd/' + cliente_id + '/' +  fecha_de_emision_inicio + '/' + fecha_de_emision_final + '/' + serie + '/' + numero + '/' + empresa_id + '/'+ numero_pedido+ '/' + orden_compra + '/' + numero_guia;
                window.open(url, '_blank');
...
<div class="container-fluid" style="margin: 0 25px;">
    <form method="post" action="<?PHP echo base_url()?>index.php/comprobantes_compras/index" name="form1" id="form1">    
        <h2>Lista de Compras: <b><?php echo $empresa['empresa']?></b></h2>
...
<div style="width: 98%;margin: 0 auto;margin-top: 1rem;margin-bottom: 0;">
    <div class="row" style="padding-bottom: 0;margin-bottom: 0;" align="right">
        <div class="d-flex justify-content-end" style="padding-bottom: 0;margin-bottom: 0;overflow: hidden;"> 
            ...
            <div class="col-md-8">
                <a href="<?PHP echo base_url(); ?>index.php/comprobantes_compras/nuevo/<?php echo $empresa['id']?>" class="btn btn-success">Nueva Compra</a>
                <a id="exportarExcel" class="btn btn-primary"><i class="glyphicon glyphicon-save"></i> REPORTE COMPRAS</a>
...
<div style="width: 96%;margin: 0 auto; padding: .4rem 0;">
    ...
    var dataSource = new kendo.data.DataSource({
         transport: {
            read: {
                url:"<?php echo base_url()?>index.php/comprobantes_compras/getMainList/",
                dataType:"json",
                method:'post',
                data:function(){
                    return {
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
                    ...
                    {field:'Tipo_doc',title:'T.DOCUMENTO',width:'80px'},
        ...
        dataBound:function(e){
            ...
            $(".show_pdf").click(function(e) {               
                var _val = $(this).attr("idval");
                javascript:window.open('<?PHP echo base_url() ?>index.php/comprobantes_compras/pdfGeneraComprobanteOffLine/'+_val+'','','width=750,height=600,scrollbars=yes,resizable=yes');
                
            });
             $(".delete").click(function(e) {               
                var _val = $(this).attr("idval");
                if(confirm("¿ Esta seguro eliminar compra ?")){
                   window.location.href = "<?PHP echo base_url() ?>index.php/comprobantes_compras/eliminar/"+_val;
                }
