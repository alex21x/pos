...
<script>
    ...
    $("#modificar_empresa").click(function(e){
        ...
        /*var ruc = $("#ruc").val();
        if(ruc!=''){
            $.get("http://sistemasunat.com/API_SUNAT/register_asociados.php",{ruc})
             .done(function(res){
                 console.log(res);
             })
        }*/
       ...
       $.ajax({
            ...
            success:function(response){
                ...
                if(response.status == STATUS_OK)
                {
                     ...
                     /*$.ajax({
                            method:'post',
                            url:"<?php echo API_SUNAT_LOCAL?>/SITIFACSUNAT/index.php/Sunat/register_CERT",
                            data:formData,
                            dataType:'json',
                            cache:false,
                            contentType: false,
                            processData: false,
                            success:function(response){
                                toast("success", 1500, 'Validación 2 : OK');
