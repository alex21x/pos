        ...
        <div class="col-md-6">           
            ...
            <form class="form-horizontal" role="form"  method="POST" id="formNuevoCliente">
                ...
                <div id="datos">    
                    ...
                    <div class="form-group">
                        <label for="domicilio2" class="col-xs-4 col-md-5 col-lg-5 control-label text-right">Domicilio 2</label>
                        <div class="col-xs-8 col-md-7 col-lg-7">
                    ...
                    <div class="form-group">
                      <label for="placa" class="col-xs-4 col-md-5 col-lg-5 control-label text-right">Placa :</label>
                      <div class="col-xs-4 col-md-7">
                      <input type="text" class="form-control" name="placa" id="placa" placeholder="placa">
                    </div>
                    </div>
                     <div class="form-group">
                        <label for="rubro" class="col-xs-4 col-md-5 col-lg-5 control-label text-right">Rubro:</label>
                        <div class="col-xs-8 col-md-7 col-lg-7">                                                
                    ...
                    <div class="form-group">
                        <label for="zona " class="col-xs-4 col-md-5 col-lg-5 control-label text-right">Zona:</label>
                        <div class="col-xs-8 col-md-7 col-lg-7">
                    ...
                    <div class="form-group">
                        <label for="puntos " class="col-xs-4 col-md-5 col-lg-5 control-label text-right">Ubicación Maps:</label>
                        <div class="col-xs-8 col-md-7 col-lg-7">
