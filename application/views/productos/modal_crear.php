          ...
          <div class="col-md-12">
            <div class="form-group">
              <label for="prod_observaciones">Observaciones</label>
                <textarea id="prod_observaciones" name="prod_observaciones" class="form-control input-sm"><?php echo $producto->prod_observaciones;?></textarea>              
            </div>
          </div> 
  ...
  <script>    
    ...
    $(document).on('change','#prod_imagen',function(){      
       $("#images_gallery").html('');
           var archivos = document.getElementById('prod_imagen').files;
