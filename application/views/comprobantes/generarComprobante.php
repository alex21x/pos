                       ...
                       <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2 input_busqueda"><br>
                        ...
                        <div class="col-xs-6 col-md-2 col-lg-2">
                           ...
                           <?PHP foreach ($monedas as $value) { 
                                    ...
                                    <option value = "<?PHP echo $value->id;?>" <?= $SELECTED?>><?PHP echo $value->moneda;?></option>
                           <?PHP }?>    
                           </select>
                        </div> 
                            ...
                            <table id="tabla" class="table">
                                ...
                                <tr class="cont-item">
                                    ...
                                    <td class="col-sm-3"><textarea class="form-control" rows="2" id="descripcion" name="descripcion[]" required="" readonly><?PHP echo $val['descripcion'];?></textarea><div id="data_item"><input type="hidden" name="item_id[]" id="item_id" value="<?php echo $val['producto_id']?>"></div> </td>
                                     ...
                                     <?PHP } ?>
                                    <td><input type="text" id="serie_detalle" name="serie_detalle[]"  class="form-control serie_detalle" value="<?= $val['serie_detalle']?>"></td>
                                    <td><input type="number" id="cantidad" name="cantidad[]" class="form-control cantidad" value="<?PHP echo $val['cantidad'];?>"></td>
                                    <td class="col-sm-2">
