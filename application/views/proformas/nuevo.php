...
<?PHP
  if($proforma->prof_id == '') $proforma->prof_mostrar_imagen = 2;
?>
<div class="container-fluid">
<form id="formComprobante" class="form-horizontal">
                    ...
                    <div class="form-group" style="padding-top:20px;">                        
                       ...
                       <!-- <div class="col-xs-2 col-md-2 col-lg-2">
                        ...
                        <div class="col-xs-12 col-md-2 col-lg-2">
                            ...
                            <input type= "text" class="form-control" id="placa" name="placa" value="<?php echo $proforma->placa;?>">
                        </div>                         
                            ...
                            <div class="row" id="valida">
                                <div class="col-xs-12 col-md-12 col-lg-12">
                                            ...
                                            <?php foreach($proforma->detalles as $item):?>                                              
                                                <tr class="cont-item">
                                                  ...
                                                  <?PHP } else { ?>
                                                    ...
                                                    <?PHP }?>    
                                                    <td><input type="text" class="form-control serie_detalle" id="serie_detalle" name="serie_detalle[]" value="<?= $item->profd_serie_detalle?>"></td>
                                                    <td><input type="number" class="form-control cantidad" id="cantidad" name="cantidad[]"  value="<?= $item->profd_cantidad;?>"></td>                                                   
                                    ...
                                    <label>Mostrar Imagen                                      
                                      <?PHP $CHECKED = ($proforma->prof_mostrar_imagen ==  1) ? 'CHECKED' : '';?>
    ...
    <div class="row" style="padding-top:20px;">               
        ...
        <div class="input-group">
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <?php if($proforma->prof_id > 0):?>
                    <button id="guardar" type="button" class="btn btn-primary btn-lg btn-block">Actualizar proforma</button> 
                <?php else:?>
                    <button id="guardar" type="button" class="btn btn-primary btn-lg btn-block">Registrar Proforma1</button> 
                <?php endif?>
