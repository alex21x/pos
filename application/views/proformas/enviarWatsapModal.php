...
$(document).ready(function(){
  ...
  $(document).on("click",".enviarWatsap",function(){    
    ...
    var url_pdf = '%0AFORMATO%20A4%20:<?= base_url()?>'+'index.php/download/downloadPdf_pf/'+proforma_id;
    var url_pdfTicket = '%0AFORMATO%20TICKET%20:<?= base_url()?>'+'index.php/download/downloadPdfTicket_pf/'+proforma_id;    
    $.ajax({
