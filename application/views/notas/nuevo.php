                                    ...
                                    <table id="tabla" class="table table-striped" <?php if(count($nota->detalles)==0):?> style="display:none" <?php endif?> >
                                        ...
                                        <tbody>                                                      
                                            <?php foreach($nota->detalles as $item):?>
                                                <tr class="cont-item">
                                                    <?PHP if($item->notapd_producto_id != 0){?>
                                                    ...
                                                    <td style="display: none;"><input type="text" class="form-control" readonly id="medida" name="medida[]" value="<?php echo $item->notapd_unidad_id?>"></td>
                                                    <?PHP } else { ?>
                                                      <td class="col-sm-3">
                                                      <textarea class="form-control descripcion-item" rows="2" id="descripcion" name="descripcion[]" required=""><?PHP echo $item->notapd_descripcion;?></textarea>
                                                      <div id="data_item"><input type="hidden" name="item_id[]" id="item_id" value="<?php echo $item->notapd_producto_id?>"></div>
                                                    </td>
                                                    <td class="col-sm-1">
                                                    ...
                                                    <?PHP }?>
                                                    <td><input type="text" id="serie_detalle" name="serie_detalle[]"  class="form-control serie_detalle" value="<?= $item->notapd_serie_detalle?>"></td>
                                                    <td>
