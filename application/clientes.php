    ...
    public function ExportarExcel($id='',$estado='',$tipo='') {
        ...
        */
        ...
        $spreadsheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('H1', 'TELEFONO_FIJO_1')
                ->setCellValue('I1', 'TELEFONO_MOVIL_1')
                ->setCellValue('J1', 'PLACA')
                ->setCellValue('K1', 'RUBRO')
                ->setCellValue('L1', 'DESCUENTO')
                ->setCellValue('M1', 'LINEA_DE_CREDITO')
                ->setCellValue('N1', 'ZONA')
                ->setCellValue('O1', 'PUNTOS')
                ->setCellValue('P1', 'BONUS');
        ...
        foreach ($rsCliente as $value) {
            ...
            $spreadsheet->getActiveSheet()
                        ...
                        ->setCellValue('H'.$i, $value->telefono_fijo_1)
                        ->setCellValue('I'.$i, $value->telefono_movil_1)
                        ->setCellValue('J'.$i, $value->placa)
                        ->setCellValue('K'.$i, $value->tcr_nombre)
                        ->setCellValue('L'.$i, $value->descuento)
                        ->setCellValue('M'.$i, $value->linea_de_credito)
                        ->setCellValue('N'.$i, $value->zona)
                        ->setCellValue('O'.$i, $value->puntos)
                        ->setCellValue('P'.$i, $value->bonus);
